...
class FairyTailViewController: UIViewController {
    ...
    var fairyTailsBrain = FairyTailsBrain()
    ...
    func updateView() -> Void {
        let entities = fairyTailsBrain.getCurrentEntities()
        ...
        nextButton.isHidden     = fairyTailsBrain.isLastEntity()
        previousButton.isHidden = fairyTailsBrain.isFirstEntity()
    }
    
    func bookImagePressed(buttonNumber: Int, imageView: UIImageView) -> Void {
        if let url = URL(string: fairyTailsBrain.getCurrentEntities()[buttonNumber].url) {
    ...
    @IBAction func previousButtonPressed(_ sender: UIButton) {
        fairyTailsBrain.previousEntity()
        updateView()
    }
    
    @IBAction func nextButtonPrerssed(_ sender: UIButton) {
        fairyTailsBrain.nextEntity()
        updateView()
    }
}
